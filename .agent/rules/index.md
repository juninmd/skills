...
Lista de regras e padrões:


- [command_safety](./command_safety.md)
- [deployment_constraints](./deployment_constraints.md)
- [env_secrets](./env_secrets.md)
- [git_standards](./git_standards.md)
