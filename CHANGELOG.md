...
* code review ([7718204](https://gitlab.luizalabs.com/luizalabs/padrao-labs-agents/commit/7718204))
...
* improve agents ([47e40e2](https://gitlab.luizalabs.com/luizalabs/padrao-labs-agents/commit/47e40e2))
* improve agents ([25bde2d](https://gitlab.luizalabs.com/luizalabs/padrao-labs-agents/commit/25bde2d))
...
* keybind ([472f7a9](https://gitlab.luizalabs.com/luizalabs/padrao-labs-agents/commit/472f7a9))
...
* add comprehensive rules for CI/CD, command safety, documentation standards, environment secrets, git workflow, and more ([46c9fcc](https://gitlab.luizalabs.com/luizalabs/padrao-labs-agents/commit/46c9fcc))
