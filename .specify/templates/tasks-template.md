...
> Generated from: `.specify/specs/[feature]/plan.md`
...
- **TASK-001**: Create directory structure and configuration files [.specify/specs/[feature]/] [depends: none]
- **TASK-002**: Set up package.json, tsconfig, and build configuration [.specify/specs/[feature]/] [depends: TASK-001]
...
### Core Implementation
- **TASK-006**: Implement [core component/function] [src/[feature].ts] [depends: TASK-005]
...
- **TASK-008**: Create unit tests for P1 implementation [src/__tests__/[feature].test.ts] [depends: TASK-006, TASK-007]
