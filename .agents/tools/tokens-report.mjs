...
// Ratchet: 4300 -> 4600 for the eight ops and GoldSrc skills. The per-skill
// ceiling did not move, so the catalog grew by adding skills, not by letting
// descriptions get fatter.
