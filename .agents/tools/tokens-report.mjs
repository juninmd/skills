...
// Ratchet: 4300 -> 4400 when the catalog grew from 65 to 70 skills, then
// -> 4600 for the eight ops and GoldSrc skills. The per-skill ceiling did not
// move, so the catalog grew by adding skills, not by letting descriptions get
// fatter.
export const TIER1_BUDGET = 4600;
