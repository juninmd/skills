...
*   **Rationale:** Untyped or untested code is not accepted in Labs standard. Prioritize correct typing before new features.
...
| Situation | Subagent |
|---|---|
| API security review | `labs-secops-agent` |
