...
description: "Use when gathering context, searching code, or reducing prompt bloat with targeted reads and cache hygiene. Triggers: context efficiency, targeted search, prompt hygiene, token usage."
applyTo: '**/*'
---
