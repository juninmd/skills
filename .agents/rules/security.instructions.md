---
name: security
description: "Use when validating inputs, reviewing auth, handling secrets, or applying OWASP-aligned security controls. Triggers: security, OWASP, input validation, auth middleware, secret protection."
