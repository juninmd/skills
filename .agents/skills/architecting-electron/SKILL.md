...
description: Design and architect cross-platform Electron applications with proper separation between Main Process (Node.js), Renderer Process (UI framework), and Native Integration layer, including security, performance, and resilience patterns.
metadata:
    works_on: [copilot]
