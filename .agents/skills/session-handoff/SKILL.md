...
description: |
  Write the note that lets whoever picks this work up next resume it without rediscovering anything. Use for pausing mid-task, passing unfinished work to a teammate or a fresh window, and recording decisions, dead ends, and the exact next command.
---
