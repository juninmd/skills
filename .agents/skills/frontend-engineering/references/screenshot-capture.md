...
## Reference Routing
- Exact commands for capture, hydration waits, determinism flags, auth storage state, and teardown on both shells: [playwright-recipes.md](playwright-recipes.md)
