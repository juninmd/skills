...
name: api-design
description: |
  Design and evolve HTTP, GraphQL, gRPC, and event contracts that stay compatible for consumers. Use for the OpenAPI contract for a public REST API, resource modeling, request and response shapes, versioning, pagination, idempotency, error envelopes, breaking-change review, and deprecation policy.
---
