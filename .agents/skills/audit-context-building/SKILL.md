...
This skill governs **how the assistant reasons** during the context-building phase of an audit.
...
Before deep analysis, the assistant performs a minimal mapping:
...
When performing ultra-granular analysis, the assistant MUST structure output following the format defined in [OUTPUT_REQUIREMENTS.md](resources/OUTPUT_REQUIREMENTS.md).
...
The assistant may spawn subagents for:
...
- Return summaries that the assistant integrates into its global model.
...
While active, the assistant should NOT:
...
- [Data Privacy Rule](../../rules/data-privacy.instructions.md)
