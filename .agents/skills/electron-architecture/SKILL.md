...
description: |
  Design secure Electron desktop apps split across main and renderer processes. Use for process boundaries, inter-process messaging, preload bridges, context isolation, sandboxing, native OS integration, and desktop startup cost.
---
...
## Reference Routing
- Main process structure and services: [main-process.md](references/main-process.md)
- Renderer and UI patterns: [renderer-patterns.md](references/renderer-patterns.md)
- Security configuration and hardening: [security.md](references/security.md)
- Native integration and performance: [native-performance.md](references/native-performance.md)
