...
- `ci-knife mgc-bucket-deploy`: Deploy de estáticos no Magalu Cloud Object Storage.

## Security
- `ci-knife security-scanner`: Envia código para análise no Santuário de Atena.
