...
**Use CONTEXT.md vocabulary for the domain, and the [codebase-design.md](codebase-design.md) vocabulary for the architecture.** If `CONTEXT.md` defines "Order," talk about "the Order intake module," not "the FooBarHandler," and not "the Order service."
