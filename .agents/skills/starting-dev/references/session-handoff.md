...
- Reusable lessons do not belong here — a note dies with the branch. Durable learnings go to [session-learnings procedure](session-learnings.md).
- Budgeting what stays loaded while the work is still running is a different job: `agent-engineering`.
