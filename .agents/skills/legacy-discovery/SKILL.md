...
description: |
  Reconstruct documentation for an undocumented legacy system. Use for mapping an inherited codebase, recovering implicit business rules, writing retroactive decision records, producing design docs and API specs from source, or planning a rewrite.
---
