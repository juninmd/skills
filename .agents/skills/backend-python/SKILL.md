...
- Environment, pyproject, and tasks: [python-setup.md](references/python-setup.md)
- Migration and patterns: [migration-checklist.md](references/migration-checklist.md), [modern-python-patterns.md](references/modern-python-patterns.md)
