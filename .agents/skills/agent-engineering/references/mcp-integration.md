...
## Reference Routing
- HTTP auth and origin hardening, long-running tool semantics, and the protocol-client assertion list: [transport-auth-and-testing.md](transport-auth-and-testing.md)
