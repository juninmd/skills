# Form Filling Guide: File System Architect

## Project Structure Design Form
To propose a new project structure, provide the following information:

| Field | Description | Example |
|-------|-------------|---------|
| Project Type | Type of application | "React Web App", "Python CLI", "Monorepo" |
| Framework | Core framework used | "Next.js", "Django", "Go" |
