...
description: SSL/CA certificate configurations to ensure connectivity in environments protected by Netskope at MyProject.
metadata:
...
### Overview
Netskope is a cloud security platform used at MyProject to control internet access. In protected environments, tools like `npm`, `pip`, and `gcloud` may face SSL connectivity issues.

### When to Apply
- Whenever working in MyProject development or production environments that use Netskope.
