...
description: |
  Give the project one vocabulary and keep the code spelling it the same way. Use for a glossary, naming a concept, the same thing called three names, business terms that do not match the types, and writing CONTEXT.md so people and tools share one language.
---
