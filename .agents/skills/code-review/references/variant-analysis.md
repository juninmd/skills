...
## Stop
- The pattern cannot be stated in one sentence. Go back to `observability`; you have a symptom, not a class.
...
- Reviewing one diff for defects is [expert-review procedure](expert-review.md); this skill starts after a defect is already understood.
