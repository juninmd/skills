...
- [ ] Analyze merge state, upstream state, and related branch groups before proposing deletions.
- [ ] Present the safety analysis before any destructive command.
- [ ] Require explicit confirmation before deleting any branch or worktree.
