...
name: design-systems
description: |
  Build and maintain a shared component library other teams depend on. Use for design tokens, theming and dark mode, component API and variant design, Figma-to-code parity, library documentation, and versioning a published UI package.
---
