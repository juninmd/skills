---
name: goldsrc-bsp-maintenance
description: |
  Read, audit and edit compiled GoldSrc and Counter-Strike 1.6 .bsp files, including maps with no source. Use for ripent, editing the entity lump without recompiling, BSP30 parsing, engine limit audits, and spawn points buried inside geometry.
license: MIT
---
