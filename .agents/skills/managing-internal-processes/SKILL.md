---
name: managing-internal-processes
description: Management of internal processes, demand cards, operational requests, and administrative flows within MyProject.
metadata:
...
This skill helps navigate and manage non-technical requests and administrative flows using the standard MyProject portals.

## Key Portals
- **Turia (IAM):** [https://identity.example.com](https://identity.example.com)
...
- **Kirk:** [https://kirk.example.com](https://kirk.example.com)
...
- It manages Identity and Access Management (IAM) for MyProject internalorate systems.
