...
description: |
  Measure and reduce the unit cost of running software: cloud spend and LLM token spend. Use for cutting the cloud bill, idle and orphaned resources, cost attribution, rightsizing, egress and storage tiering, caching economics, token budgets, model routing, and budget guardrails.
---
