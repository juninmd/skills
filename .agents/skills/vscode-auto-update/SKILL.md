...
description: "Skill to automate updating Visual Studio Code on Debian/Ubuntu x86_64 by downloading the official .deb and installing it reliably. Use to perform one-off updates or schedule automatic updates."
