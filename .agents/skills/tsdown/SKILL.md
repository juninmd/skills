...
- [ ] Decide the public entry points, output formats, and external dependencies before configuring the bundle.
- [ ] Keep declaration output and package exports aligned with the built artifacts.
- [ ] Validate the built package with the consumer environment that matters most.
