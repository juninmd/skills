...
## Reference Routing
- Practical failure casebook: [diagnostics-real-world-cases.md](diagnostics-real-world-cases.md)
- Full debugging sequence: [debugging-phases.md](debugging-phases.md)
- Connectivity, DNS, routing, sockets: [network-connectivity.md](network-connectivity.md)
- HTTP and TLS: [network-http-ssl.md](network-http-ssl.md)
