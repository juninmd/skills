...
## Reference Routing
- Practical cases: [real-world-cases.md](real-world-cases.md)
- Severity matrix, comms cadence, mitigation decision tree: [incident-playbook.md](incident-playbook.md)
- Postmortem template and standards: [postmortem-standards.md](postmortem-standards.md)
