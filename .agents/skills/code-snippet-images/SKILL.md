...
description: |
  Render a code snippet as a shareable image through a carbon-style service driven by URL query parameters. Use for README hero images, slide decks and PR descriptions, tuning theme, font, padding and window chrome, and capturing the export node.
---
