...
5. Prepare a concrete PR title and body from the final diff and repository template: problem, resulting behavior, relevant design decisions, verification, and material limits. Do not paste raw logs, secrets, or conversational history. Complete this work even if publication authorization is missing.
...
- [ ] Concrete PR body prepared; publication uses existing explicit authorization.
