...
Every pressable in the app. This passes the frequency gate only because it's near-imperceptible: 120ms and a 3% scale is the ceiling for something touched this often — anything longer or larger belongs to rarer moments, per step 1 in [animate-expo.md](animate-expo.md). No gesture, no shared value — a CSS transition is the whole implementation.
