...
description: |
  Compile GoldSrc and Counter-Strike 1.6 maps with the ZHLT or VHLT toolchain and diagnose build failures. Use for hlcsg, hlbsp, hlvis and hlrad errors, a wad file it could not open, LEAK, AllocBlock full, a fullbright map, black outdoor shadows, and running the tools on Windows.
license: MIT
---
