---
name: labs-validating-baseweb-charts
...
## Reference Files
The configuration templates based on the Luizalabs standard are located in the `resources/` directory of this skill:
- `.agents/skills/labs-validating-baseweb-charts/resources/Chart.yaml`
- `.agents/skills/labs-validating-baseweb-charts/resources/values.yaml`
