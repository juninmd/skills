...
- [ ] Confirm the interpreter, environment manager, and test entry points before changing dependencies.
- [ ] Prefer typed, small, single-purpose modules over broad utility buckets.
- [ ] Re-run the narrowest lint, typecheck, or test command that covers the change.
