---
name: goldsrc-map-authoring
description: |
  Author GoldSrc and Counter-Strike 1.6 map geometry in the Valve 220 .map format, by hand or generated from code. Use for writing brushes, walls with door openings, plane winding, texture axes, mirrored sign text, textures tiling instead of fitting, CSG rules, and brushes that disappear.
license: MIT
---
