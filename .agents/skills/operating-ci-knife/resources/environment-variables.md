...
| :--- | :--- | :--- |
| `CIKNIFE_IMAGE` | Imagem Docker padrão (ex: `gcr.io/example-cicd/ci-knife:v1.10.2`) | Sim |
...
| `DOCKER_REPO` | Repositório de imagens (ex: `gcr.io/example-cicd/meu-app`) | Sim (para deploy) |
