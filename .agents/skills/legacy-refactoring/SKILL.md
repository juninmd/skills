...
description: |
  Change an untested class safely without breaking it. Use for characterization tests, finding seams, breaking hidden dependencies, sprout and wrap, strangling a legacy subsystem behind a facade, and a feature in a module nobody dares to touch.
---
