...
Este plugin é focado em segurança ofensiva e defensiva, auditoria de código, resposta a incidentes e gestão de segredos.

## 🤖 Agents
- **SecOps Agent** (`secops-agent`): Especializado em triagem de vulnerabilidades, auditoria forense e conformidade de segurança.
